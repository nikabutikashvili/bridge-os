...
export default function WorkPackagesLoading(): React.ReactElement {
  return (
    <div className="flex min-h-0 flex-1 flex-col px-4 pt-4">
      <LoadingSkeleton label="Loading work package identity" lines={1} />
      ...
      <div className="mt-4 min-h-0 flex-1 border border-border bg-card px-3 py-3">
        <LoadingSkeleton label="Loading work packages" lines={7} />
      </div>
    </div>
  );
}
